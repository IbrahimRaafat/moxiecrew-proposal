      ...
      <div className="max-w-7xl mx-auto px-6">
        <div className="flex items-center gap-6 mb-16">
          ...
          <div>
            ...
            <p className="text-lg text-muted mt-2">Complete website revamp & loyalty system</p>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <motion.div
            ...
            viewport={{ once: true }}
            className="p-12 bg-gradient-to-br from-primary to-primary/80 text-white rounded-2xl border-2 border-accent"
          >
            <div className="text-center mb-8">
              <h3 className="font-display text-3xl font-bold mb-4">Website Revamp</h3>
            </div>
          ...
          <motion.div
            ...
            viewport={{ once: true }}
            className="p-12 bg-gradient-to-br from-accent to-accent/80 text-white rounded-2xl border-2 border-primary flex flex-col"
          >
            <div className="text-center mb-8">
              <h3 className="font-display text-3xl font-bold mb-4">Current Website Management/Maintenance</h3>
            </div>
